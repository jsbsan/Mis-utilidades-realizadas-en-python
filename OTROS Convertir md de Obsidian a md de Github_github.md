**Utilidad:**
Un fichero markdown con el formato obsidian hay que variar como se escriben los enlaces de imagenes y descarga de ficheros para que lo acepte github

**Prompt:**
- Extrae la lógica a aplicar en un programa que lo haga para cualquier enlace de imagen y enlace de descarga, siguiendo estos ejemplo:

``` obsidian
Un enlace de imagen en mardown, por ejemplo:
![-](./ANEXOS/Pastedimage20260218092557.png)
Para markdow en github sería:
![-](./ANEXOS/Pastedimage20260218092557.png)

Un enlace de descarga en mardown, por ejemplo:
[descargar](./ANEXOS/DeExcel-a-CSV-MK.py)
Para markdow en github sería:
[descargar](./ANEXOS/DeExcel-a-CSV-MK.py)
```
- haz un script en python con entorno visual, para que sea facil seleccionar los archivos y crear el resultante
...
    # Extraer el contenido dentro de [descargar](./ANEXOS/...)
...
            # Regex para encontrar [descargar](./ANEXOS/nombre_archivo)
...
Código fuente:
[descargar](./ANEXOS/ObsidianAGithub.py)